    ...
    <li class="relative px-6 py-3">
      ...
      <li class="relative px-6 py-3">
        ...
        >
          ...
          <span class="ml-4">Reclamations</span>
        </a>
      </li>
    ...
    <li class="relative px-6 py-3">
      ...
      <template x-if="isPagesMenuOpen">
        ...
        >
          ...
          >
            <a class="w-full" href="{{ route('user-show') }}">
             Utilisateurs
            </a>
          </li>
          <li
            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          >
            <a class="w-full" href="{{ route('api-show') }}">
              API key
            </a>
          </li>
      ...
      <template x-if="isPagesMenuOpen">
        ...
        >
          ...
          {{-- <li
            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          >
            <a class="w-full" href="{{ route('tarifications') }}">Tarifications</a>
          </li> --}}
